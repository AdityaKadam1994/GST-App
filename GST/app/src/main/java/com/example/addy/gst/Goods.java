...
public class Goods extends AppCompatActivity {
    ...
    ListView goodlv1;
    String [] suboptions= {"Goods @0%","Goods @3%","Goods @5%","Goods @12%","Goods @18%","Goods @28%"};
    int []Images={R.drawable.cartl,R.drawable.cartl,R.drawable.cartl,R.drawable.cartl,R.drawable.cartl,R.drawable.cartl};
    @Override
